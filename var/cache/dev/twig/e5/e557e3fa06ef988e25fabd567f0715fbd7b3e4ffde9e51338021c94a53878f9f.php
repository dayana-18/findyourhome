...
class __TwigTemplate_c02669d79797ab573e86664e1d427aa1bf7fc597c5d7681063e0a3753345ddec extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 3
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), "photo", [], "any", false, false, false, 3), 'row');
        echo "
    <button class=\"btn\">";
        // line 4
...
{{ form_end(form) }}", "appartement/_form.html.twig", "/home/dayanavr/www/findyourhome/templates/appartement/_form.html.twig");
    }
}
