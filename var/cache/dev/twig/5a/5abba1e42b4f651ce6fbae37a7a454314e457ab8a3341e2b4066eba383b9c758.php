...
class __TwigTemplate_33f4754120f365061c15850ddf2a9f6cb262d8ddfe4e756ebdeaacce7365efc6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <button class=\"btn\"><a href=\"";
        // line 10
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("utilisateur_show", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["utilisateur"]) || array_key_exists("utilisateur", $context) ? $context["utilisateur"] : (function () { throw new RuntimeError('Variable "utilisateur" does not exist.', 10, $this->source); })()), "id", [], "any", false, false, false, 10)]), "html", null, true);
        echo "\">Retourner au profil</a></button>
...
{% block body %}
    ...
    {{ include('utilisateur/_form.html.twig', {'button_label': 'Mis à jour'}) }}

    <button class=\"btn\"><a href=\"{{ path('utilisateur_show', {'id': utilisateur.id}) }}\">Retourner au profil</a></button>

    {{ include('utilisateur/_delete_form.html.twig') }}
{% endblock %}
", "utilisateur/edit.html.twig", "/home/dayanavr/www/findyourhome/templates/utilisateur/edit.html.twig");
    }
}
