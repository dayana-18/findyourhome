...
class __TwigTemplate_8b094d86bd5c6ad6a5c17d653cc1829107b0537a0d38702755f73e2bf19661ed extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("client_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["client"]) || array_key_exists("client", $context) ? $context["client"] : (function () { throw new RuntimeError('Variable "client" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "client/show.html.twig", "/home/dayanavr/www/findyourhome/templates/client/show.html.twig");
    }
}
