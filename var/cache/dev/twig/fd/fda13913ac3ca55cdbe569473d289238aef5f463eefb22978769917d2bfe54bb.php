...
class __TwigTemplate_7ce5aa6a06ce52ddaa0e2cda6aa486a2b10d068a335668e4b3141064a49c2702 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("proprietaire_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["proprietaire"]) || array_key_exists("proprietaire", $context) ? $context["proprietaire"] : (function () { throw new RuntimeError('Variable "proprietaire" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
        echo "\">edit</a>
...
{% endblock %}
", "proprietaire/show.html.twig", "/home/dayanavr/www/findyourhome/templates/proprietaire/show.html.twig");
    }
}
