...
class Appartement extends \App\Entity\Appartement implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     * {@inheritDoc}
     */
    public function setPreavis(bool $preavis): \App\Entity\Appartement
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPreavis', [$preavis]);

        return parent::setPreavis($preavis);
    }
     ...
     * {@inheritDoc}
     */
    public function addId(\App\Entity\Client $id): \App\Entity\Appartement
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addId', [$id]);

        return parent::addId($id);
    }

    /**
     * {@inheritDoc}
     */
    public function removeId(\App\Entity\Client $id): \App\Entity\Appartement
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeId', [$id]);

        return parent::removeId($id);
    }
