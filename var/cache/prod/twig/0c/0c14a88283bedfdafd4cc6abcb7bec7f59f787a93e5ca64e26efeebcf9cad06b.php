...
class __TwigTemplate_1e37987ce5b92f1cd350c09520f6a1cd6806f436fa310da1e8b9229ee4185edc extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["registrationForm"] ?? null), "login", [], "any", false, false, false, 9), 'row');
        echo "
        ";
        // line 10
...
";
    ...
    {
        return new Source("", "registration/register.html.twig", "/home/dayanavr/www/findyourhome/templates/registration/register.html.twig");
    }
}
